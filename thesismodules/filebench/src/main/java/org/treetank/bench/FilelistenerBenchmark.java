...
import org.treetank.filelistener.file.FilesystemNotification;
import org.treetank.filelistener.file.FilesystemNotificationObserver;
...
public class FilelistenerBenchmark implements FilesystemNotificationObserver {
    ...
    @Test
    public void bench(int filebenchSize) throws FileNotFoundException, ClassNotFoundException, IOException,
        ...
        while (!finishedBench) {
            ...
            if (n.getRelativePath() != null) {
                ...
                if (fileMap.get(n.getRelativePath()) == 9)
                    finishedBench = true;
            }
        }
        if (finishedBench) {
