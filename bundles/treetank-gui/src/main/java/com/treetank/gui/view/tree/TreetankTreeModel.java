 ...
 * 
 * <p>Extends an AbstractTreeModel and implements main methods, used to 
 * construct the Tree representation with Treetank items.</p>
 * 
...
//    if (index >= 0 && index < getChildCount(parent)) {
      ...
      case ELEMENT_KIND:
        ...
        // Children.
        for (long childIndex = 0, childCount =
...
//    return null;
  ...
  private int getChildIndex(final IItem parentNode, final IItem childNode) {
    int index = -1;
    final long childCount = ((IStructuralNode) parentNode).getChildCount();
