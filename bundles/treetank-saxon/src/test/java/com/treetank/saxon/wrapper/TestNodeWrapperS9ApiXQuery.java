...
public final class TestNodeWrapperS9ApiXQuery {
	...
	private static final File BOOKSXML = new File(new StringBuilder("src")
			...
			.append("resources").append(File.separator).append("books.xml")
			.toString());
	...
	public void testWhereBooks() {
		final XQueryEvaluator xqe = new XQueryEvaluator(
				"for $x in /bookstore/book where $x/price>30 return $x/title",
				sessionBooks, TestHelper.PATHS.PATH1.getFile()
						.getAbsoluteFile(), new ByteArrayOutputStream());
