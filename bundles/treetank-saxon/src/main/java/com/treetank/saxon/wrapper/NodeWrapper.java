 ...
 * <h1>NodeWrapper</h1>
 * 
 * <p>Wraps a Treetank node into Saxon's internal representation of a node. It 
 * therefore implements Saxon's core interface NodeInfo as well as two others:</p>
 * 
 * <dl>
 *   <dt>NodeInfo</dt>
 *   <dd>The NodeInfo interface represents a node in Saxon's implementation of 
 *   the XPath 2.0 data model.</dd>
 *   <dt>VirtualNode</dt>
 ...
 *   node underlying the virtual node, for use by applications that need to 
 *   drill down to the underlying data. </dd>
 *   <dt>SiblingCountingNode</dt>
 *   <dd>Interface that extends NodeInfo by providing a method to get the 
 *   position of a node relative to its siblings.</dd>
 * </dl>
 * 
...
public class NodeWrapper implements NodeInfo, VirtualNode, SiblingCountingNode {
  ...
  public int compareOrder(final NodeInfo node) {
    ...
    //      new ElementNode(mKey, parent, firstChild, leftSibling, rightSibling, nameKey, uriKey, typeKey).compareTo();
    //      break;
    //    case ATTRIBUTE_KIND:
    //
    //      break;
