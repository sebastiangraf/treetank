 ...
 *
 */
public class XQueryEvaluator implements Callable<SAXDestination> {
   ...
   */
  public XQueryEvaluator(final String expression, final ISession session, final File file, final ContentHandler handler) {
