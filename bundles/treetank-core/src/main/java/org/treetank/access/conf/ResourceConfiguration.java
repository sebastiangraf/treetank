...
public final class ResourceConfiguration implements IConfigureSerializable {
	...
	private ResourceConfiguration(
			final ResourceConfiguration.Builder paramBuilder) {
		...
		mPath = new File(new File(mDBConfig.mFile,
	...
	public File getConfigFile() {
		final File file = new File(mPath, Paths.ConfigBinary.getFile()
				.getName());
		return file;
	}
	...
	public static final class Builder {
		...
		public Builder(final String paramResource,
				final DatabaseConfiguration paramConfig) {
		...
		public Builder setRevisionsToRestore(final int paramRevisionsToRestore) {
			if (paramRevisionsToRestore <= 0) {
				throw new IllegalArgumentException(
						"paramRevisionsToRestore must be > 0!");
			}
