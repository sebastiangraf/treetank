...
public abstract class SerializerBuilder {
  ...
  /**
   * Axis used for iterating over Treetank storage.
   */
  IAxis mAxis;
  ...
  public static class SAXSerializerBuilder extends SerializerBuilder {
    ...
    public SAXSerializerBuilder(final IAxis axis, final ContentHandler handler) {
      super(axis);
      mHandler = handler;
    }
    ...
    public SAXSerializer build() {
      return new SAXSerializer(mAxis, mHandler, this);
    }
  }

  public static class RevisionedXMLSerializerBuilder
      extends
    ...
    public RevisionedXMLSerializerBuilder(
