...
public final class RelationalDBImport implements IImport {
     ...
     *            SQL query used to extract revisions.
     */
    public RelationalDBImport(final String driverClass, final String connURL,
            final String userName, final String userPass, final String SQLQuery) {
        ...
        try {
            ...
            mConnection = DriverManager.getConnection(mConnURL, mUserName,
                    mUserPass);
    ...
    public void check(final Object database, final Object tsps) {
        try {
            final PreparedStatement prepStatement = mConnection
                    .prepareStatement(mSQLQuery);
