...
public final class RelationalDBImport implements IImport {
     ...
     */
    public RelationalDBImport(final String driverClass, final String connURL, final String userName,
    ...
    public void check(final Object database, final Object obj) {
        try {
            final PreparedStatement prepStatement = mConnection.prepareStatement((String)obj);
