...
public class XMLUpdateShredderTest extends XMLTestCase {
  ...
  public static final String XMLINSERT =
      RESOURCES + File.separator + "revXMLsInsert";

  public static final String XMLDELETE =
      RESOURCES + File.separator + "revXMLsDelete";
      ...
      if (file.getName().endsWith(".xml")) {
        ...
        if (first) {
          final XMLShredder shredder =
              new XMLShredder(wtx, XMLShredder.createReader(file), true);
          shredder.call();
          first = false;
        } else {
          final XMLShredder shredder =
