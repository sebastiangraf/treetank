...
//	private final String Q22_Fac001 = "/site/open_auctions/open_auction[@id=\"open_auction0\"]/bidder/personref[@person=\"person175\"]";
//	private final String R22_Fac001 = "<personref person=\"person175\"/>";
//
//	private final String Q23_Fac001 = "/site/people/person[@id=\"person3\"][address and (phone or homepage)]/name";
//	private final String R23_Fac001 = "<name>Mehrdad Suermann</name>";
	...
	public String getQuery(final int queryNr, final String factor) {
		...
		try {
			Field privateStringField = XMarkBenchQueries.class
