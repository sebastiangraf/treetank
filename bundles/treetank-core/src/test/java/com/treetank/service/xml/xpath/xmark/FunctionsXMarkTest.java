...
public class FunctionsXMarkTest {
	...
	// public void testNot() {
	// final String query =
	// "/site/people/person[not(homepage)][@id=\"person1\"]/name/text()";
	...
	// public void testId() {
	// final String query =
	// "fn:id(/site/people/person[@id=\"person1\"]/watches/watch/@open_auction)";
	// final String result = "";
	// XPathStringChecker.testIAxisConventions(new XPathAxis(rtx, query),
	// new String[] { result });
	// }
	...
	// final String query =
	// "for $b in /site/people/person[@id=\"person0\"] return fn:data($b/name)";
	// final String result = "Krishna Merle";
	// XPathStringChecker.testIAxisConventions(new XPathAxis(rtx, query),
	// new String[] { result });
	// }
	...
	// final String query =
	// "exactly-one(/site/people/person[@id=\"person0\"]/name)";
	...
	// public void testSum() {
	// final String query =
	// "fn:sum(/site/open_auctions/open_auction/bidder/increase/text())";
	...
	// final String query =
	// "fn:root()/site/people/person[@id=\"person0\"]/name/text()";
	// final String result = "Krishna Merle";
	// XPathStringChecker.testIAxisConventions(new XPathAxis(rtx, query),
	// new String[] { result });
	// }
	...
	// final String result =
	// "<element attribute=\"12.00\"/><element attribute=\"12.00\"/>";
	// XPathStringChecker.testIAxisConventions(new XPathAxis(rtx, query),
	// new String[] { result });
	// }
