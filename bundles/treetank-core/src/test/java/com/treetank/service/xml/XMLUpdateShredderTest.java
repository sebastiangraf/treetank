 ...
 * 
 */
public class XMLUpdateShredderTest extends XMLTestCase {
    public static final String RESOURCES = "src" + File.separator + "test"
            + File.separator + "resources";

    public static final String XMLINSERT = RESOURCES + File.separator
            + "revXMLsInsert";

    public static final String XMLDELETE = RESOURCES + File.separator
            + "revXMLsDelete";

    public static final String XMLSAME = RESOURCES + File.separator
            + "revXMLsSame";
            ...
            if (file.getName().endsWith(".xml")) {
                ...
                if (first) {
                    final XMLShredder shredder = new XMLShredder(wtx,
                            XMLShredder.createReader(file), true);
                    shredder.call();
                    first = false;
                } else {
