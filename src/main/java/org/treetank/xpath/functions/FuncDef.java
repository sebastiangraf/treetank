...
public enum FuncDef {
  ...
  // * </p>
  // * <p>
  // * The fn:error function raises an error. While this function never returns
  // a
  // * value, an error is returned to the external processing environment as an
  // * xs:anyURI or an xs:QName. The error xs:anyURI is derived from the error
  // * xs:QName. An error xs:QName with namespace URI NS and local part LP will
  // be
  ...
  // * division is performed so that the sign of the fractional part is the same
  ...
  // * unchanged: (+ $arg). Semantically, this operation performs no operation.
  // * </p>
  // */
  ...
  // * <p>
  // * Backs up the unary "-" operator and returns its operand with the sign
  // * reversed: (- $arg). If $arg is positive, its negative is returned; if it
  // is
  ...
  // the
  // * same as the type of $arg. If the type of $arg is a type derived from one
  // of
  ...
  // * </p>
  // * <p>
  // * The value returned is the nearest (that is, numerically closest) value to
   ...
   * </p>
   */
  CODEPNT2STR("fn:codepoints-to-string", AbstractFunction.class, 0, 1,
      "xs:string"),
   ...
   */
  STR2CODEPNT("fn:string-to-codepoints", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   */
  ESCAPE_HTML_URI("fn:escape-html-uri", AbstractFunction.class, 1, 1,
      "xs:string"),
   ...
   * <p>
   */
  SUBSTR_BEFORE("fn:substring-before", AbstractFunction.class, 2, 3,
      "xs:string"),
   ...
   * </p>
   */
  YMD_LT("op:yearMonthDuration-less-than", AbstractFunction.class, 2, 2,
      "xs:boolean"),
   ...
   * </p>
   */
  YMD_GT("op:yearMonthDuration-greater-than", AbstractFunction.class, 2, 2,
      "xs:boolean"),
   ...
   * </p>
   */
  DTD_LT("op:dayTimeDuration-less-than", AbstractFunction.class, 2, 2,
      "xs:boolean"),
   ...
   * </p>
   */
  DTD_GT("op:dayTimeDuration-greater-than", AbstractFunction.class, 2, 2,
      "xs:boolean"),
   ...
   * </p>
   */
  MON_FROM_DUR("fn:months-from-duration", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   * </p>
   */
  YEAR_FROM_DUR("fn:years-from-duration", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   * </p>
   */
  DAYS_FROM_DUR("fn:days-from-duration", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   * </p>
   */
  HOURS_FROM_DUR("fn:hours-from-duration", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   * </p>
   */
  MIN_FROM_DUR("fn:minutes-from-duration", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   * </p>
   */
  SEC_FROM_DUR("fn:seconds-from-duration", AbstractFunction.class, 1, 1,
      "xs:decimal"),
   ...
   * </p>
   */
  YEAR_FROM_DT("fn:year-from-dateTime", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   * </p>
   */
  MON_FROM_DT("fn:month-from-dateTime", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   * </p>
   */
  DAY_FROM_DT("fn:day-from-dateTime", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   * </p>
   */
  HOURS_FROM_DT("fn:hours-from-dateTime", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   * </p>
   */
  MIN_FROM_DT("fn:minutes-from-dateTime", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   * </p>
   */
  SEC_FROM_DT("fn:seconds-from-dateTime", AbstractFunction.class, 1, 1,
      "xs:decimal"),
   ...
   * </p>
   */
  TZ_FROM_DT("fn:timezone-from-dateTime", AbstractFunction.class, 1, 1,
      "xs:dayTimeDuration"),
   ...
   * </p>
   */
  YEAR_FROM_DATE("fn:year-from-date", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   * </p>
   */
  MON_FROM_DATE("fn:month-from-date", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   * </p>
   */
  TZ_FROM_DATE("fn:timezone-from-date", AbstractFunction.class, 1, 1,
      "xs:dayTimeDuration"),
   ...
   * </p>
   */
  HOURS_FROM_TIME("fn:hours-from-time", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   * </p>
   */
  MIN_FROM_TIME("fn:minutes-from-time", AbstractFunction.class, 1, 1,
      "xs:integer"),
   ...
   * </p>
   */
  SEC_FROM_TIME("fn:seconds-from-time", AbstractFunction.class, 1, 1,
      "xs:decimal"),
   ...
   * </p>
   */
  TZ_FROM_TIME("fn:timezone-from-time", AbstractFunction.class, 1, 1,
      "xs:dayTimeDuration"),
   ...
   * </p>
   */
  ADD_YMD("op:add-yearMonthDurations", AbstractFunction.class, 2, 2,
   ...
   * </p>
   */
  SUB_YMD("op:subtract-yearMonthDurations", AbstractFunction.class, 2, 2,
      "xs:yearMonthDuration"),
   ...
   * </p>
   */
  MUL_YMD("op:multiply-yearMonthDuration", AbstractFunction.class, 2, 2,
      "xs:yearMonthDuration"),
   ...
   * </p>
   */
  DIV_YMD("op:divide-yearMonthDuration", AbstractFunction.class, 2, 2,
      "xs:yearMonthDuration"),
   ...
   * </p>
   */
  DIV_YMD_BY_YMD("op:divide-yearMonthDuration-by-yearMonthDuration",
      AbstractFunction.class, 2, 2, "xs:decimal"),
   ...
   * </p>
   */
  ADD_DTD("op:add-dayTimeDurations", AbstractFunction.class, 2, 2,
      "xs:dayTimeDuration"),
   ...
   * </p>
   */
  SUB_DTD("op:subtract-dayTimeDurations", AbstractFunction.class, 2, 2,
      "xs:dayTimeDuration"),
   ...
   * </p>
   */
  MUL_DTD("op:multiply-dayTimeDuration", AbstractFunction.class, 2, 2,
      "xs:dayTimeDuration"),
   ...
   * </p>
   */
  DIV_DTD("op:divide-dayTimeDuration", AbstractFunction.class, 2, 2,
      "xs:dayTimeDuration"),
   ...
   * </p>
   */
  DIV_DTD_BY_DTD("op:divide-dayTimeDuration-by-dayTimeDuration",
      AbstractFunction.class, 2, 2, "xs:decimal"),
   ...
   * </p>
   */
  ADJUST_DT2TZ("fn:adjust-dateTime-to-timezone", AbstractFunction.class, 1, 2,
      "xs:dateTime"),
   ...
   * </p>
   */
  ADJUST_DATE2TZ("fn:adjust-date-to-timezone", AbstractFunction.class, 1, 2,
      "xs:date"),
   ...
   * </p>
   */
  ADJUST_TIME2TZ("fn:adjust-time-to-timezone", AbstractFunction.class, 1, 2,
      "xs:time"),
   ...
   * </p>
   */
  SUB_DT("op:subtract-dateTimes", AbstractFunction.class, 2, 2,
      "xs:dayTimeDuration"),
   ...
   * </p>
   */
  SUB_DATES("op:subtract-dates", AbstractFunction.class, 2, 2,
      "xs:dayTimeDuration"),
   ...
   * </p>
   */
  SUB_TIMES("op:subtract-times", AbstractFunction.class, 2, 2,
      "xs:dayTimeDuration"),
   ...
   * </p>
   */
  ADD_YMD2DT("op:add-yearMonthDuration-to-dateTime", AbstractFunction.class, 2,
      2, "xs:dateTime"),
   ...
   * </p>
   */
  ADD_DTD2DT("op:add-dayTimeDuration-to-dateTime", AbstractFunction.class, 2,
      2, "xs:dateTime"),
   ...
   * </p>
   */
  SUB_YMD_FROM_DT("op:subtract-yearMonthDuration-from-dateTime",
      AbstractFunction.class, 2, 2, "xs:dateTime"),
   ...
   * </p>
   */
  SUB_DTD_FROM_DT("op:subtract-dayTimeDuration-from-dateTime",
      AbstractFunction.class, 2, 2, "xs:dateTime"),
   ...
   * </p>
   */
  ADD_YMD2DATE("op:add-yearMonthDuration-to-date", AbstractFunction.class, 2,
      2, "xs:date"),
   ...
   * </p>
   */
  ADD_DTD2DATE("op:add-dayTimeDuration-to-date", AbstractFunction.class, 2, 2,
      "xs:date"),
   ...
   * </p>
   */
  SUB_YMD_FROM_DATE("op:subtract-yearMonthDuration-from-date",
      AbstractFunction.class, 2, 2, "xs:date"),
   ...
   * </p>
   */
  SUB_DTD_FROM_DATE("op:subtract-dayTimeDuration-from-date",
      AbstractFunction.class, 2, 2, "xs:date"),
   ...
   * </p>
   */
  ADD_DTD2TIME("op:add-dayTimeDuration-to-time", AbstractFunction.class, 2, 2,
      "xs:time"),
   ...
   * </p>
   */
  SUB_DTD_FROM_TIME("op:subtract-dayTimeDuration-from-time",
      AbstractFunction.class, 2, 2, "xs:time"),
   ...
   * </p>
   */
  NS_URI_FROM_QNAME("fn:namespace-uri-from-QName", AbstractFunction.class, 1,
      1, "xs:anyURI"),
   ...
   * </p>
   */
  NS_URI4PREF("fn:namespace-uri-for-prefix", AbstractFunction.class, 2, 2,
      "xs:anyURI"),
   ...
   * </p>
   */
  IN_SCOPE_PREF("fn:in-scope-prefixes", AbstractFunction.class, 1, 1,
      "xs:string"),
   ...
   * </p>
   */
  BASE64BIN_EQ("op:base64Binary-equal", AbstractFunction.class, 2, 2,
      "xs:boolean"),
   ...
   * </p>
   */
  LOC_NAME_FROM_QNAME("fn:local-name-from-QName", AbstractFunction.class, 1, 1,
      "xs:NCName"),
  ...
  // * </p>
  // * <p>
  // * Returns a sequence consisting of the items in $seq1 followed by the items
   ...
   * </p>
   */
  DIST_VALUES("fn:distinct-values", AbstractFunction.class, 1, 2,
      "xs:anyAtomicType"),
  //
  // /**
  // * <p>
  ...
  // * <p>
  // * </p>
  // * fn:subsequence( $sourceSeq as item()*, $startingLoc as xs:double, $length
  ...
  // * </p>
  // */
  // ZERO_OR_ONE("fn:zero-or-one", AbstractFunction.class, FNCount.class, 1, 1,
  // ),
  ...
  // * </p>
  // */
  // ONE_OR_MORE("fn:one-or-more", AbstractFunction.class, FNCount.class, 1, 1),
  ...
  // * </p>
  // */
  // EXACTLY_ONE("fn:exactly-one", AbstractFunction.class, FNCount.class, 1, 1),
  //
  /**
   * <p>
  ...
  // an
  // * error is raised [err:FODC0005]. If it is a relative URI Reference, it is
  ...
  // Section
  // * C.2 Dynamic Context ComponentsXP. If the value of the default collection
  // is
   ...
   * </p>
   */
  IMPLICIT_TZ("fn:implicit-timezone", AbstractFunction.class, 0, 0,
      "xs:dayTimeDuration"),
   ...
   * </p>
   */
  DEFAULT_COLL("fn:default-collation", AbstractFunction.class, 0, 0,
      "xs:string"),
   ...
   * </p>
   */
  STATIC_BASE_URI("fn:static-base-uri", AbstractFunction.class, 0, 0,
      "xs:anyURI");
