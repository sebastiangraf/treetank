...
public class FilelistenerTest {
    ...
    public void setUp() throws Exception {
        StorageManager.createResource(RESOURCE_1,  new ModuleSetter().setNodeFacClass(FileNodeFactory.class).setMetaFacClass(FilelistenerMetaPageFactory.class)
            .setRevisioningClass(SlidingSnapshot.class).setBackendClass(JCloudsStorage.class).createModule());
        StorageManager.createResource(RESOURCE_2,  new ModuleSetter().setNodeFacClass(FileNodeFactory.class).setMetaFacClass(FilelistenerMetaPageFactory.class)
            .setRevisioningClass(SlidingSnapshot.class).setBackendClass(JCloudsStorage.class).createModule());
     ...
     */
    @Test
    public void testFilelistener() throws FileNotFoundException, ClassNotFoundException, IOException, StorageNotExistingException, TTException {
